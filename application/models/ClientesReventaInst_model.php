...
class ClientesReventaInst_model extends CI_Model {
   ...
   function update_cobros($precioFinal, $porcentaje, $fecha_hoy, $fecha_vencimiento, $parcialidades, $total, $compartido, $id_cliente, $prosa, $mensualidad, $id_contrato, $id_contrato_old, $lugar_prospeccion, $area, $user){      
      $this->db->query("UPDATE [cobros] SET cantidad = ".$precioFinal.", fecha_cobro = GETDATE(), descuento = ".$porcentaje.", fecha_vencimiento = '".$fecha_vencimiento."', fecha_creacion = GETDATE(), parcialidades = ".$parcialidades.", mensualidad = ".$mensualidad.", total = ".$total.", compartido = ".$compartido.", servicio = ".$area.", prosa = ".$prosa.", id_contrato = ".$id_contrato.", lugar_prospeccion=".$lugar_prospeccion.", modificado_por = ".$user."  WHERE id_contrato =".$id_contrato_old."");
   }
   ...
   function update_tarjeta($id_contrato_old, $id_contrato, $user){
      $this->db->query("UPDATE tarjetas SET id_contrato = ".$id_contrato.", modificado_por = ".$user." WHERE id_contrato = ".$id_contrato_old."");
   }
   
   function insert_cobros($insert_id, $precioFinal, $mesesi, $porcentaje, $fecha_actual, $parcialidades, $formaPago, $pagoCon, $montoEnganche, $total, $compartido, $area, $referencia, $prosa, $mensualidad, $id_contrato, $lugar_prospeccion, $clave_rastreo, $user){
   ...
   public function update_historial_pagos($id_contrato_old, $id_contrato, $user){
      $this->db->query("UPDATE [historial_pagos] SET id_contrato = ".$id_contrato.", modificado_por = ".$user." WHERE id_contrato = ".$id_contrato_old." AND descripcion = 'Anticipo hecho tras firmar el contrato.'");
   }

   public function update_paquetes($id_contrato_old, $id_contrato, $user){
      $this->db->query("UPDATE [paquetes] SET id_contrato = ".$id_contrato.", modificado_por = ".$user." WHERE id_contrato = ".$id_contrato_old."");
   }
