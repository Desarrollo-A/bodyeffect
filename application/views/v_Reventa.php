				...
				<div class="box">
					<div class="box-body">
						<div class="box-header with-border">
							<div class="">
								<div class="card-body">
									<h3>DATOS DEL CLIENTE [REVENTA]</h3>
										...
										<div class="tab-content">
											<div role="tabpanel" class="tab-pane fade active show" id="cliente1">
												...
												<div class="row">
													<div class="col col-xs-12 col-sm-12 col-md-12 col-lg-12">
														<h4>Elige un cliente</h4>
														<select class="form-control g-disabld myselect" id="clientes_lista"></select>
														<small>ó bien puedes continuar con el seleccionado en la parte inferior*</small><br><br>
													</div>
													<div class="col-md-2 form-group">
														<input type="text" id="area_sel" name="area_sel" hidden>
														<input type="hidden" id="id_cliente_actual" name="id_cliente_actual" value="<?php echo $data_cliente->id_cliente;?>">
														<label>* Nombres</label>
														<input class="form-control field-disabld" name="nombre[]" id="nombre_titular" readonly placeholder="Nombre" autocomplete="off" onkeyup="mayus(this);" onkeypress="return onlyLetters(event)" value="<?php echo $data_cliente->nombre;?>" maxlength="100" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"/>
													</div>
													<div class="col-md-2 form-group">
														<label>* Apellido paterno</label>
														<input class="form-control field-disabld" name="apellido_paterno[]" value="<?php echo $data_cliente->apellido_paterno;?>" id="ap_titular" readonly placeholder="Apellido paterno" autocomplete="off" onkeyup="mayus(this);" onkeypress="return onlyLetters(event)" maxlength="100" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"/>
													</div>
													<div class="col-md-2 form-group">
														<label>* Apellido materno</label>
														<input class="form-control field-disabld" name="apellido_materno[]" id="am_titular" readonly value="<?php echo $data_cliente->apellido_materno;?>" placeholder="Apellido materno" autocomplete="off" onkeyup="mayus(this);" onkeypress="return onlyLetters(event)"  maxlength="100" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"/>
													</div>
													<div class="col-md-2 form-group">
														<label>* Correo electrónico</label>
														<input type="text" class="form-control field-disabld" name="correo[]" id="correo_titular" readonly placeholder="Correo" autocomplete="off" onkeyup="mayus(this);" maxlength="100"  value="<?php echo $data_cliente->correo;?>" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" title="Por favor, introduzca una dirección de correo electrónico válida." onkeypress="return onlyLettersMail(event)"/>
													</div>
													<div class="col-md-2 form-group">
														<label>* Teléfono</label>
														<input type="tel" class="form-control field-disabld " name="telefono[]" placeholder="Teléfono" autocomplete="off"
														id="telefono_titular" readonly
														value="<?php echo $data_cliente->telefono;?>"/>
													</div>
													<style>
													...
													<div class="col-md-2 form-group">
														...
														<div class="form-check">
															<label class="form-check-label" name="radioT">
																<input title="Persona responsable de pagar paquete(s) contratado(s)." type="radio" class=" form-check-input" name="checkT" value="1" checked readonly>
															</label>
														</div>
															...
															<div class="container p-0 mb-5">
	                                                            <div class="row">
	                                                                <div class="col-md-10 p-0 text-right">
	                                                                    <input class="form-control field-disabld domicilio" value="<?php echo $data_cliente->domicilio;?>" name="domicilio[]" placeholder="Domicilio" autocomplete="off" onkeyup="mayus(this);" maxlength="500" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" readonly id="domicilio_titular"/>
	                                                                </div>
													...
													<div class="col-md-12 form-group areas-depmol">
														<div class="table-wrapper-scroll-y">
															<table class="table">
																...
																<tr>
																	<th colspan="5" scope="col" id="flechaDesplegar_4" class="style-encabezado-tbl"><h5 class="no-mrg">Áreas seleccionadas </h5><i class="fa fa-chevron-up" style="float: right;margin-top: -16px;"></i></th>
																</tr>
																</thead>
											...
											<div role="tabpanel" class="tab-pane fade" id="cliente2">
												...
												<div class="row">
													<div class="col col-xs-12 col-sm-12 col-md-12 col-lg-12">
														<h4>Elige un cliente</h4>
														<select class="form-control g-disabld myselect" id="clientes2_lista">
														</select>
														<small>ó bien puedes continuar con el seleccionado en la parte inferior*</small><br><br>
														<br>
														<br>
													...
													<div class="col-md-2 form-group">
														...
														id="nombre_cl2" placeholder="Nombre" autocomplete="off" onkeyup="mayus(this);" onkeypress="return onlyLetters(event)" maxlength="100" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"/>
													</div>
													<div class="col-md-2 form-group">
														<label>* Apellido paterno</label>
														<input class="form-control field-disabld" name="apellido_paterno[]" id="apellido_paternocl2" placeholder="Apellido paterno" autocomplete="off" onkeyup="mayus(this);" onkeypress="return onlyLetters(event)" maxlength="100" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"/>
													</div>
													<div class="col-md-2 form-group">
														<label>* Apellido materno</label>
														<input class="form-control field-disabld" name="apellido_materno[]" id="apellido_maternocl2" placeholder="Apellido materno" autocomplete="off" onkeyup="mayus(this);" onkeypress="return onlyLetters(event)" maxlength="100" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"/>
													</div>
													<div class="col-md-2 form-group">
														<label>* Correo electrónico</label>
														<input type="text" class="form-control field-disabld" name="correo[]" id="correo_cl2" placeholder="Correo" autocomplete="off" onkeyup="mayus(this);" maxlength="100" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" title="Por favor, introduzca una dirección de correo electrónico válida." onkeypress="return onlyLettersMail(event)"/>
													</div>
													<div class="col-md-2 form-group">
														<label>* Teléfono</label>
														<input type="tel" class="form-control field-disabld" name="telefono[]" id="tel_cl2" placeholder="Teléfono" autocomplete="off" minlength="14" maxlength="14" onkeyup="phoneMask(this);"/>
													</div>
													<div class="col-md-2 form-group">
														<label>¿Es titular?</label>
														<div class="form-check">
															<label class="form-check-label" name="radioT">
																<input type="radio" class="form-check-input" name="checkT" value="2" disabled>
															</label>
														</div>
													...
													<div class="col-md-12">
														<div class="form-group">
															<div class="container p-0 mb-5">
	                                                            <div class="row">
	                                                                <div class="col-md-10 p-0 text-right">
	                                                                    <input class="form-control field-disabld domicilio" name="domicilio[]" placeholder="Domicilio" autocomplete="off" onkeyup="mayus(this);"  maxlength="500" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" />
	                                                                </div>
	                                                                <div class="col-md-2 p-0 text-right">
	                                                                    <button type="button" id="cuerpo-completo2" class="btn cuerpo-completo-btn d-none"><i class="fas fa-child m-1"></i>Cuerpo completo</button>
	                                                                </div>
	                                                            </div>
	                                                        </div>
	                                                        <div class="row areas-depmol">
													...
													<div class="col-md-12 form-group areas-depmol">
														<div class="table-wrapper-scroll-y">
															<table class="table">
																<thead class="thead-dark-first header">
																	<tr>
																		<th colspan="5" scope="col" id="flechaDesplegar_5" class="style-encabezado-tbl"><h5 class="no-mrg">Áreas seleccionadas </h5><i class="fa fa-chevron-up" style="float: right;margin-top: -16px;"></i></th>
																	</tr>
																</thead>
											...
											<div role="tabpanel" class="tab-pane fade" id="cliente3">
												<div class="row">
													<div class="col col-xs-12 col-sm-12 col-md-12 col-lg-12">
														<h4>Elige un cliente</h4>
														<select class="form-control g-disabld myselect" id="clientes3_lista"></select>
														<small>ó bien puedes continuar con el seleccionado en la parte inferior*</small><br><br>
														<br><br>
													</div>
													<div class="col-md-12 mt-2">
												...
												<div class="row">
													<div class="col-md-2 form-group">
														<label>* Nombres</label>
														<input class="form-control field-disabld" name="nombre[]"  placeholder="Nombre" id="nombre_cl3" autocomplete="off" onkeyup="mayus(this);" onkeypress="return onlyLetters(event)" maxlength="100" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"/>
													</div>
													<div class="col-md-2 form-group">
														<label>* Apellido paterno</label>
														<input class="form-control field-disabld" name="apellido_paterno[]" id="apellido_paternocl3" placeholder="Apellido paterno" autocomplete="off" onkeyup="mayus(this);" onkeypress="return onlyLetters(event)" maxlength="100" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"/>
													</div>
													<div class="col-md-2 form-group">
														<label>* Apellido materno</label>
														<input class="form-control field-disabld" name="apellido_materno[]" id="apellido_maternocl3" placeholder="Apellido materno" autocomplete="off" onkeyup="mayus(this);" onkeypress="return onlyLetters(event)" maxlength="100" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"/>
													</div>
													<div class="col-md-2 form-group">
														<label>* Correo electrónico</label>
														<input type="text" class="form-control field-disabld" name="correo[]" id="correo_cl3" placeholder="Correo" autocomplete="off" onkeyup="mayus(this);" maxlength="100" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" title="Por favor, introduzca una dirección de correo electrónico válida." onkeypress="return onlyLettersMail(event)"/>
													</div>
													<div class="col-md-2 form-group">
														<label>* Teléfono</label>
														<input type="tel" class="form-control field-disabld" name="telefono[]" id="tel_cl3" placeholder="Teléfono" autocomplete="off" minlength="14" maxlength="14" onkeyup="phoneMask(this);">
													</div>
													<div class="col-md-2 form-group">
														<label>¿Es titular?</label>
														<div class="form-check">
															<label class="form-check-label" name="radioT">
																<input type="radio" class="form-check-input" name="checkT" value="3" disabled>
															</label>
														</div>
														...
														<div class="form-group">
															<div class="container p-0 mb-5">
	                                                            <div class="row">
	                                                                ...
	                                                                <div class="col-md-2 p-0 text-right">
	                                                                    <button type="button" id="cuerpo-completo3" class="btn cuerpo-completo-btn d-none"><i class="fas fa-child m-1"></i>Cuerpo completo</button>
	                                                                </div>
	                                                            </div>
	                                                        </div>
	                                                        <div class="row areas-depmol">
													...
													<div class="col-md-12 form-group areas-depmol">
														<div class="table-wrapper-scroll-y">
															<table class="table">
																<thead class="thead-dark-first header">
																<tr>
																<th colspan="5" scope="col" id="flechaDesplegar" class="style-encabezado-tbl"><h5 class="no-mrg">Áreas seleccionadas </h5><i class="fa fa-chevron-up" style="float: right;margin-top: -16px;"></i></th>
																</tr>
																</thead>
											...
											<div role="tabpanel" class="tab-pane fade" id="cliente4">
												<div class="row">
													<div class="col col-xs-12 col-sm-12 col-md-12 col-lg-12">
														<h4>Elige un cliente</h4>
														<select class="form-control g-disabld myselect" id="clientes4_lista"></select>
														<small>ó bien puedes continuar con el seleccionado en la parte inferior*</small><br><br>
														<br><br>
													</div>
													<div class="col-md-12 mt-2">
												...
												<div class="row">
													<div class="col-md-2 form-group">
														<label>* Nombres</label>
														<input class="form-control field-disabld" name="nombre[]"  placeholder="Nombre" id="nombre_cl4"  autocomplete="off" onkeyup="mayus(this);" onkeypress="return onlyLetters(event)" maxlength="100" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"/>
													</div>
													<div class="col-md-2 form-group">
														<label>* Apellido paterno</label>
														<input class="form-control field-disabld" name="apellido_paterno[]" id="apellido_paternocl4" placeholder="Apellido paterno" autocomplete="off" onkeyup="mayus(this);" onkeypress="return onlyLetters(event)" maxlength="100" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"/>
													</div>
													<div class="col-md-2 form-group">
														<label>* Apellido materno</label>
														<input class="form-control field-disabld" name="apellido_materno[]" id="apellido_maternocl4" placeholder="Apellido materno" autocomplete="off" onkeyup="mayus(this);" onkeypress="return onlyLetters(event)" maxlength="100" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"/>
													</div>
													<div class="col-md-2 form-group">
														<label>* Correo electrónico</label>
														<input type="text" class="form-control field-disabld" name="correo[]" id="correo_cl4" placeholder="Correo" autocomplete="off" onkeyup="mayus(this);" maxlength="100" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" title="Por favor, introduzca una dirección de correo electrónico válida." onkeypress="return onlyLettersMail(event)"/>
													</div>
													<div class="col-md-2 form-group">
														<label>* Teléfono</label>
														<input type="tel" class="form-control field-disabld" name="telefono[]" id="tel_cl4" placeholder="Teléfono" autocomplete="off" minlength="14" maxlength="14" onkeyup="phoneMask(this);">
													</div>
													<div class="col-md-2 form-group">
														<label>¿Es titular?</label>
														<div class="form-check">
															<label class="form-check-label" name="radioT">
																<input type="radio" class="form-check-input" name="checkT" value="4" disabled>
															</label>
														</div>
														...
														<div class="form-group">
															<div class="container p-0 mb-5">
	                                                            <div class="row">
	                                                                ...
	                                                                <div class="col-md-2 p-0 text-right">
	                                                                    <button type="button" id="cuerpo-completo4" class="btn cuerpo-completo-btn d-none"><i class="fas fa-child m-1"></i>Cuerpo completo</button>
	                                                                </div>
	                                                            </div>
	                                                        </div>
	                                                        <div class="row areas-depmol">
													...
													<div class="col-md-12 form-group areas-depmol">
														<div class="table-wrapper-scroll-y">
															<table class="table">
																<thead class="thead-dark-first header">
																	<tr>
                                                                    <th colspan="5" scope="col" id="flechaDesplegar_2" class="style-encabezado-tbl"><h5 class="no-mrg">Áreas seleccionadas </h5><i class="fa fa-chevron-up" style="float: right;margin-top: -16px;"></i></th>
																	</tr>
																</thead>
											...
											<div role="tabpanel" class="tab-pane fade" id="cliente5">
												<div class="row">
													<div class="col col-xs-12 col-sm-12 col-md-12 col-lg-12">
														<h4>Elige un cliente</h4>
														<select class="form-control g-disabld myselect" id="clientes5_lista"></select>
														<small>ó bien puedes continuar con el seleccionado en la parte inferior*</small><br><br>
														<br><br>
													</div>
													<div class="col-md-12 mt-2">
												...
												<div class="row">
													<div class="col-md-2 form-group">
														<label>* Nombres</label>
														<input class="form-control field-disabld" name="nombre[]"  placeholder="Nombre" id="nombre_cl5" autocomplete="off" onkeyup="mayus(this);" onkeypress="return onlyLetters(event)" maxlength="100" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"/>
													</div>
													<div class="col-md-2 form-group">
														<label>* Apellido paterno</label>
														<input class="form-control field-disabld" name="apellido_paterno[]" id="apellido_paternocl5" placeholder="Apellido paterno" autocomplete="off" onkeyup="mayus(this);" onkeypress="return onlyLetters(event)" maxlength="100" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"/>
													</div>
													<div class="col-md-2 form-group">
														<label>* Apellido materno</label>
														<input class="form-control field-disabld" name="apellido_materno[]" id="apellido_maternocl5" placeholder="Apellido materno" autocomplete="off" onkeyup="mayus(this);" onkeypress="return onlyLetters(event)" maxlength="100" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"/>
													</div>
													<div class="col-md-2 form-group">
														<label>* Correo electrónico</label>
														<input type="text" class="form-control field-disabld" name="correo[]" placeholder="Correo" id="correo_cl5" autocomplete="off" onkeyup="mayus(this);" maxlength="100" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" title="Por favor, introduzca una dirección de correo electrónico válida." onkeypress="return onlyLettersMail(event)"/>
													</div>
													<div class="col-md-2 form-group">
														<label>* Teléfono</label>
														<input type="tel" class="form-control field-disabld" name="telefono[]" id="tel_cl5" placeholder="Teléfono" autocomplete="off" minlength="14" maxlength="14" onkeyup="phoneMask(this);">
													</div>
													<div class="col-md-2 form-group">
														<label>¿Es titular?</label>
														<div class="form-check">
															<label class="form-check-label" name="radioT">
																<input type="radio" class="form-check-input" name="checkT" value="5" disabled>
															</label>
														</div>
														...
														<div class="form-group">
															<div class="container p-0 mb-5">
	                                                            <div class="row">
	                                                                ...
	                                                                <div class="col-md-2 p-0 text-right">
	                                                                    <button type="button" id="cuerpo-completo5" class="btn cuerpo-completo-btn d-none"><i class="fas fa-child m-1"></i>Cuerpo completo</button>
	                                                                </div>
	                                                            </div>
	                                                        </div>
	                                                        <div class="row areas-depmol">
													...
													<div class="col-md-12 form-group areas-depmol">
														<div class="table-wrapper-scroll-y">
															<table class="table">
																<thead class="thead-dark-first header">
																<tr>
																<th colspan="5" scope="col" id="flechaDesplegar_3" class="style-encabezado-tbl"><h5 class="no-mrg style-encabezado-tbl">Áreas seleccionadas </h5><i class="fa fa-chevron-up" style="float: right;margin-top: -16px;"></i></th>
																</tr>
																</thead>
											...
											<div class="box-anticipo d-none">
												...
												<div class="row">
													...
													<div class="col-md-2 pr-1" style="display:none;">
														<div class="form-group">
															<label>Desc. depilación / moldeo</label>
															...
															<input class="form-control total-areas" type="hidden" value="0" />
															<input class="form-control total-Cuerpocompleto" type="hidden" value="0" />
														</div>
													</div>
													<div class="col-md-2 pr-1">
														<div class="form-group">
													...
													<div class="col-md-3 pr-1">
														<div class="form-group" style="display:grid">
															...
															<select id="formaPago" name="formaPago[]" class="form-control g-disabld" autocomplete="off" multiple="multiple" onchange="changePay(); changeEntrance(); changeAPagar();">
																...
																<option value='6' class="tranRequired">Transferencia bancaria</option>
															</select>
														</div>
													</div>
												</div>
												...
												<div class="col-md-3 d-none">
													<div class="form-group box-pagos">
														...
														<select id="lugar_prospeccion" name="lugar_prospeccion" class="form-control g-disabld" autocomplete="off">
														</select>
														<input type="hidden" class="form-control" name="lp" id="lp">
													</div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group box-pagos">
															<label>Observaciones</label>
															<textarea id="observaciones" name="observaciones" class="form-control g-disabld" onkeyup="mayus(this);"></textarea>
														</div> 
													</div>	 
												</div>
											</div>
														...
														<div class="row mPagoTarjeta">
															<div class="col-md-2 pr-1">
																<div class="form-group">
																	...
																	<input class="form-control g-disabld" name="cardNumber[]" id="cardNumber" placeholder="XXXX XXXX XXXX XXXX" autocomplete="off" maxlength="19" minlength="17">
																</div>
															</div>
															<div class="col-md-1 pr-1">
																<div class="form-group">
																	<label>MM</label>
																	<input type="number" class="form-control g-disabld" name="mes[]" id="mes" placeholder="MM" autocomplete="off" onkeypress="return onlyNumbers(event)" maxlength="2" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" min="01" max="12">
																</div>
															</div>
															<div class="col-md-1 pr-1">
																<div class="form-group">
																	<label>AA</label>
																	<input type="number" class="form-control g-disabld" name="anio[]" id="anio" placeholder="AA" autocomplete="off" onkeypress="return onlyNumbers(event)" maxlength="2" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" min="0" max="30">
																</div>
															</div>
															...
															<div class="col-md-1 pr-1">
																<div class="form-group box-referencia">
																	...
																	<input type="number" class="form-control g-disabld referencia" name="referencia[]" autocomplete="off">
																</div>
															</div>
														</div>
													...
													<div role="tabpanel" class="tab-pane fade .error" id="tarjeta2">
														...
														<div class="row mPagoTarjeta">
															...
															<div class="col-md-2 pr-1">
																<div class="form-group">
																	<label>Número de tarjeta</label>
																	<input class="form-control g-disabld" name="cardNumber[]" id="cardNumber2" placeholder="XXXX XXXX XXXX XXXX" autocomplete="off" maxlength="19" minlength="17">
																</div>
															</div>
															<div class="col-md-1 pr-1">
																<div class="form-group">
																	<label>MM</label>
																	<input type="number" class="form-control g-disabld" name="mes[]" id="mes2" placeholder="MM" autocomplete="off" onkeypress="return onlyNumbers(event)" maxlength="2" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" min="01" max="12">
																</div>
															</div>
															<div class="col-md-1 pr-1">
																<div class="form-group">
																	<label>AA</label>
																	<input type="number" class="form-control g-disabld" name="anio[]" id="anio2" placeholder="AA" autocomplete="off" onkeypress="return onlyNumbers(event)" maxlength="2" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" max="30">
																</div>
															</div>
															<div class="col-md-3 pr-1">
																<div class="form-group">
															...
															<div class="col-md-1 pr-1">
																<div class="form-group box-referencia">
																	<label>Referencia:</label>
																	<input type="text" class="form-control g-disabld referencia" name="referencia[]" autocomplete="off">
																</div>
															</div>
														</div>
                                            ...
                                            <h4 style="font-size:16px; margin-bottom:0">DATOS DE TRANSFERENCIA BANCARIA</h4>
												<div class="row">
													<div class="col-md-3">
														<div class="form-group box-referencia">
															<label>Clave de rastreo:</label>
															<input type="text" class="form-control" name="clave_rastreo_tb" class="clave_rastreo_tb g-disabld" id="clave_rastreo_tb" autocomplete="off" >
														</div>
													</div>
													<div class="col-md-3">
														<div class="form-group box-referencia">
															<label>Monto:</label>
															<input type="text" class="form-control monto_tb g-disabld" name="monto_tb" id="monto_tb" autocomplete="off" value = "0.00"  onkeypress="return onlyNumbers(event);" onkeyup="changeEntrance(); changeAPagar(); evalueEntranceTB(this.value)">     
														</div>
													</div>
												</div>
											</div> <!-- End div box-tb--> 
													...
													<div class="col-sm-5">
														...
														<div class="row">
															<div class="col-sm-12 box-compartida select-disabld d-none">
																<select id="enfermeras" name="enfermeras[]" multiple 
																class="form-control select-disabld listado-enfermeras" required>
																</select>
															</div>
														</div>
													</div>
											...
											<div class="row">
												<div class="col-md-12">
												<center><button id="btnsubmit" type="button" class="btn" disabled onclick="validateEmptyFields()">Finalizar venta</button></center>
                                                <center><button id="btnsubmitTwo" type="submit" class="btn d-none">Finalizar venta</button></center>
												</div>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-body">
				...
				<center><button type="button" class="btn btn-body" data-dismiss="modal" onClick="reloadPage();">Aceptar</button></center>
			</div>
...
<div id="modalRequiredFields" class="modal fade modalCenter" aria-hidden="true" data-backdrop="static" data-keyboard="false">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-body">
				<div><center><img src='<?= base_url("assets/img/alerta.png")?>' style='width:120px; height: 120px'></center></div>
				<center><label><b>Asegúrese de haber llenado los campos de <i>Nombre</i> y <i>Apellido paterno</i> de todos los clientes a los que hayas seleccionado algún servicio.</b></label></center>
				<center><button type="button" class="btn btn-body" data-dismiss="modal">Aceptar</button></center>
			</div>
		</div>
	</div>
...
<script>
	...
	$(document).ready(function () {
		/*cliente 1*/
		$select_clientes = $('#clientes_lista');
		$.post("<?=base_url()?>index.php/Reventa/get_clientes_activos", function(data) {
			var len = data.length;

			for(var i = 0; i<len; i++){
				var id = data[i]['id_cliente'];
				var name = data[i]['nombre']+' '+data[i]['apellido_paterno']+' '+data[i]['apellido_materno'];
				$("#clientes_lista").append($('<option>').val(id).text(name.toUpperCase()));
			}
		}, 'json');
		$(document).on('change', '#clientes_lista', function()
		{
			var $valor_seleccionado = $(this).val();
			$.post("<?=base_url()?>index.php/Reventa/getDataByCliente/"+$valor_seleccionado, function(data) {
				$('#nombre_titular').val(data['nombre']);
				$('#ap_titular').val(data['apellido_paterno']);
				$('#am_titular').val(data['apellido_materno']);
				$('#correo_titular').val(data['correo']);
				$('#telefono_titular').val(data['telefono']);
				$('#id_cliente_actual').val(data['id_cliente']);
				$('#domicilio_titular').val(data['domicilio']);
			}, 'json');
		});
		
		/*cliente 2*/
		$select2_clientes = $('#clientes2_lista');
		$.post("<?=base_url()?>index.php/Reventa/get_clientes_activos", function(data) {
			var len = data.length;
			for(var i = 0; i<len; i++){
				var id = data[i]['id_cliente'];
				var name = data[i]['nombre']+' '+data[i]['apellido_paterno']+' '+data[i]['apellido_materno'];
				$("#clientes2_lista").append($('<option>').val(id).text(name.toUpperCase()));
			}

		}, 'json');
		$(document).on('change', '#clientes2_lista', function()
		{
			$('#loader').removeClass('hidden');
			var $valor_seleccionado = $(this).val();
			$.post("<?=base_url()?>index.php/Reventa/getDataByCliente/"+$valor_seleccionado, function(data) {
				$('#nombre_cl2').val(data['nombre']);
				$('#apellido_paternocl2').val(data['apellido_paterno']);
				$('#apellido_maternocl2').val(data['apellido_materno']);
				$('#correo_cl2').val(data['correo']);
				$('#tel_cl2').val(data['telefono']);				
				$('#loader').addClass('hidden');
			}, 'json');
		});

		/*Cliente 3*/
		$select2_clientes = $('#clientes3_lista');
		$.post("<?=base_url()?>index.php/Reventa/get_clientes_activos", function(data) {
			var len = data.length;
			for(var i = 0; i<len; i++){
				var id = data[i]['id_cliente'];
				var name = data[i]['nombre']+' '+data[i]['apellido_paterno']+' '+data[i]['apellido_materno'];
				$("#clientes3_lista").append($('<option>').val(id).text(name.toUpperCase()));
			}
		}, 'json');
		$(document).on('change', '#clientes3_lista', function()
		{
			$('#loader').removeClass('hidden');
			var $valor_seleccionado = $(this).val();
			$.post("<?=base_url()?>index.php/Reventa/getDataByCliente/"+$valor_seleccionado, function(data) {
				$('#nombre_cl3').val(data['nombre']);
				$('#apellido_paternocl3').val(data['apellido_paterno']);
				$('#apellido_maternocl3').val(data['apellido_materno']);
				$('#correo_cl3').val(data['correo']);
				$('#tel_cl3').val(data['telefono']);				
				$('#loader').addClass('hidden');
			}, 'json');
		});
		...
		/*cliente 4*/
		$select2_clientes = $('#clientes4_lista');
		$.post("<?=base_url()?>index.php/Reventa/get_clientes_activos", function(data) {
			var len = data.length;
			for(var i = 0; i<len; i++){
				var id = data[i]['id_cliente'];
				var name = data[i]['nombre']+' '+data[i]['apellido_paterno']+' '+data[i]['apellido_materno'];
				$("#clientes4_lista").append($('<option>').val(id).text(name.toUpperCase()));
			}
		}, 'json');
		$(document).on('change', '#clientes4_lista', function()
		{
			$('#loader').removeClass('hidden');
			var $valor_seleccionado = $(this).val();
			$.post("<?=base_url()?>index.php/Reventa/getDataByCliente/"+$valor_seleccionado, function(data) {
				$('#nombre_cl4').val(data['nombre']);
				$('#apellido_paternocl4').val(data['apellido_paterno']);
				$('#apellido_maternocl4').val(data['apellido_materno']);
				$('#correo_cl4').val(data['correo']);
				$('#tel_cl4').val(data['telefono']);				
				$('#loader').addClass('hidden');
			}, 'json');
		});
		...
		correo_cl5
		tel_cl5*/
		$select2_clientes = $('#clientes5_lista');
		$.post("<?=base_url()?>index.php/Reventa/get_clientes_activos", function(data) {
			var len = data.length;
			for(var i = 0; i<len; i++){
				var id = data[i]['id_cliente'];
				var name = data[i]['nombre']+' '+data[i]['apellido_paterno']+' '+data[i]['apellido_materno'];
				$("#clientes5_lista").append($('<option>').val(id).text(name.toUpperCase()));
			}
		}, 'json');
		$(document).on('change', '#clientes5_lista', function(){
			$('#loader').removeClass('hidden');
			var $valor_seleccionado = $(this).val();
			$.post("<?=base_url()?>index.php/Reventa/getDataByCliente/"+$valor_seleccionado, function(data) {
				$('#nombre_cl5').val(data['nombre']);
				$('#apellido_paternocl5').val(data['apellido_paterno']);
				$('#apellido_maternocl5').val(data['apellido_materno']);
				$('#correo_cl5').val(data['correo']);
				$('#tel_cl5').val(data['telefono']);				
				$('#loader').addClass('hidden');
			}, 'json');
		});
	});
...
<script>
	...
	function imprimirContrato(){
		var id_cliente = $('#id_titular').val();
		var id_contrato = $('#id_contrato').val();
        window.open(url+"index.php/Archivos/contrato/"+id_cliente+"/"+id_contrato);
	}
	...
	function imprimirReciboPago(){    
		var id_contrato = $('#id_contrato').val();
		window.open(url+"index.php/Archivos/recibo/"+id_contrato); 
	}
	...
	function onlyLettersMail(e){
		key = e.keyCode || e.which;
		tecla = String.fromCharCode(key).toUpperCase();
		letras = " ABCDEFGHIJKLMNÑOPQRSTUVWXYZ@.1234567890-_";
		especiales = [];
	...
	function validateAdvance(){
		if ($('#precioFinalC').val() != 0) {
			...
			var $option = $('#lugar_prospeccion').children('option[value="'+ lp +'"]');
            ...
            $anticipo = parseInt($('#precioFinalC').val()) * 0.10;
				...
				if (parseFloat($('#precioFinalC').val()) - parseFloat($('#pagoCon').val()) == 0){
					$("#parcialidades").empty();
				...
				else if(parseFloat($('#precioFinalC').val()) - parseFloat($('#pagoCon').val()) < 0){
					$(".pago-menor-div").remove();
	...
	function changeEntrance(){
		if( (parseInt($('#efectivo').val()) + parseInt($('#montoTU').val()) + parseInt($('#montoTD').val())) + parseInt($('#monto_tb').val()) < parseInt($('#aPagar').val()))
	...
	$(document).ready(function(){
		$.post('<?=base_url()?>index.php/Clientes/getLP/', function(data) {
			var len = data.length;
			$("#lugar_prospeccion").append($('<option disabled selected>Seleccione una opción</option>'));
			for( var i = 0; i<len; i++){
				var id = data[i]['id_opcion'];
				var name = data[i]['nombre'];
				$("#lugar_prospeccion").append($('<option>').val(id).text(name.toUpperCase()));
			}
		}, 'json');
		
		//console.log("ESTE ES EL VALOR DE LP " + lugar_prospeccion);
		//$("#lugar_prospeccion").val(lugar_prospeccion);
	...
	function showDocument1(){
		...
		$(".body-document").append('<embed class="embed-doc" src="<?= base_url("assets/expediente/INE/'+nameFile+'")?>"frameborder="0" width="100%" height="600px" ><div class="modal-footer btn-closing" style="padding: 0 15px; display: flex; justify-content: flex-end;"><button type="button" class="btn btn-body" data-dismiss="modal" style="border:none; background-color:#323639; color:#FFF">Cerrar</button></div>');
	...
	function select1(){
		...
		if(slValue != undefined && slValue != null && slValue != ''){
            ...
            $(".select-uno .select2-selection--multiple").css("border", "none");
			...
			if ($('.select-uno option:selected').length > 0) {
				...
				tarifas1 = $('.select-uno option:selected').map(function () {
					var areasArray = [];
					$("#tbody-areas1").append('<tr class="row-tbl1 content-tabs" style="text-align:center"><td>'+noArea+'</td><td>'+$(this).attr("tipo")+'</td><td>'+$(this).attr("no-sesion")+'</td><td>'+$(this).attr("nombre")+'</td><td>$'+formatMoney($(this).attr("data-value"))+'</td><td hidden>'+$(this).attr("clave")+'</td></tr>');
					noArea ++;
            ...
            $(".rate-sl1").val('$'+formatMoney(suma1));
            var valor2 = parseInt(unmaskMoney($(".rate-sl1").val())) + parseInt(unmaskMoney($(".rate-sl2").val())) + parseInt(unmaskMoney($(".rate-sl3").val())) + parseInt(unmaskMoney($(".rate-sl4").val())) + parseInt(unmaskMoney($(".rate-sl5").val()));
			$("#total").val(valor2);
			...
			if (parseInt($(".total-areas").val()) == 1){				
				var total_final = parseInt($("#total").val()) * 0.40;
				$("#descuento").val((total_final + 1200));
			}


			if (parseInt($(".total-areas").val()) == 2){
				var total_final = parseInt($("#total").val()) * 0.50;
				$("#descuento").val(parseInt((total_final + 1500)));
			}

			if (parseInt($(".total-areas").val()) == 3){
				var total_final = parseInt($("#total").val()) * 0.60;
				$("#descuento").val(parseInt((total_final + 2000)));				
			}


			if (parseInt($(".total-areas").val()) >= 4){
				var total_final = parseInt($("#total").val()) * 0.65;
				$("#descuento").val(parseInt((total_final + 3000)));
			}

			if(parseInt($(".total-Cuerpocompleto").val())>15){
				var total_final = parseInt($("#total").val()) * 0.70;
				$("#descuento").val(parseInt((total_final + 3000)));
			}
		...
		if(slValue != undefined && slValue != null && slValue != ''){
			...
			if ($('.select-dos option:selected').length > 0) {
				...
				tarifas2 = $('.select-dos option:selected').map(function () {
					var areasArray = [];
					$("#tbody-areas2").append('<tr class="row-tbl2 content-tabs"><td>'+noArea+'</td><td>'+$(this).attr("tipo")+'</td><td>'+$(this).attr("no-sesion")+'</td><td>'+$(this).attr("nombre")+'</td><td>$'+formatMoney($(this).attr("data-value"))+'</td><td hidden>'+$(this).attr("clave")+'</td></tr>');
                    noArea ++;
					areasArray.push([$(this).attr("data-value"), $(this).attr("clave"), $(this).attr("value")]);
					idArea.push([$(this).attr("value")]);
					return areasArray;
			...
			$(".rate-sl2").val('$'+formatMoney(suma2));
		...
		if(slValue != undefined && slValue != null && slValue != ''){
			...
			if ($('.select-tres option:selected').length > 0) {
				...
				var tarifas3 = $('.select-tres option:selected').map(function () {
					var areasArray = [];
					$("#tbody-areas3").append('<tr class="row-tbl3 content-tabs"><td>'+noArea+'</td><td>'+$(this).attr("tipo")+'</td><td>'+$(this).attr("no-sesion")+'</td><td>'+$(this).attr("nombre")+'</td><td>$'+formatMoney($(this).attr("data-value"))+'</td><td hidden>'+$(this).attr("clave")+'</td></tr>');
					noArea ++;
					areasArray.push([$(this).attr("data-value"), $(this).attr("clave"), $(this).attr("value")]);
					idArea.push([$(this).attr("value")]);
					return areasArray;
			...
			$(".rate-sl3").val(formatMoney(suma3));

			var valor = parseInt(unmaskMoney($(".rate-sl1").val())) + parseInt(unmaskMoney($(".rate-sl2").val())) + parseInt(unmaskMoney($(".rate-sl4").val())) + parseInt(unmaskMoney($(".rate-sl5").val()));
		...
		if(slValue != undefined && slValue != null && slValue != ''){
			...
			if ($('.select-cuatro option:selected').length > 0) {
				...
				var tarifas4 = $('.select-cuatro option:selected').map(function () {
					var areasArray = [];
					$("#tbody-areas4").append('<tr class="row-tbl4 content-tabs"><td>'+noArea+'</td><td>'+$(this).attr("tipo")+'</td><td>'+$(this).attr("no-sesion")+'</td><td>'+$(this).attr("nombre")+'</td><td>$'+formatMoney($(this).attr("data-value"))+'</td><td hidden>'+$(this).attr("clave")+'</td></tr>');
					noArea ++;
					areasArray.push([$(this).attr("data-value"), $(this).attr("clave"), $(this).attr("value")]);
					idArea.push([$(this).attr("value")]);
					return areasArray;
			...
			$(".rate-sl4").val(formatMoney(suma4));

			var valor = parseInt(unmaskMoney($(".rate-sl1").val())) + parseInt(unmaskMoney($(".rate-sl2").val())) + parseInt(unmaskMoney($(".rate-sl3").val())) + parseInt(unmaskMoney($(".rate-sl5").val()));
		...
		if(slValue != undefined && slValue != null && slValue != ''){
			...
			if ($('.select-cinco option:selected').length > 0){
				...
				var tarifas5 = $('.select-cinco option:selected').map(function () {
					var areasArray = [];
					$("#tbody-areas5").append('<tr class="row-tbl5 content-tabs"><td>'+noArea+'</td><td>'+$(this).attr("tipo")+'</td><td>'+$(this).attr("no-sesion")+'</td><td>'+$(this).attr("nombre")+'</td><td>$'+formatMoney($(this).attr("data-value"))+'</td><td hidden>'+$(this).attr("clave")+'</td></tr>');
					noArea ++;
					areasArray.push([$(this).attr("data-value"), $(this).attr("clave"), $(this).attr("value")]);
					idArea.push([$(this).attr("value")]);
					return areasArray;
			...
			$(".rate-sl5").val(formatMoney(suma5));
			var valor = parseInt(unmaskMoney($(".rate-sl1").val())) + parseInt(unmaskMoney($(".rate-sl2").val())) + parseInt(unmaskMoney($(".rate-sl3").val())) + parseInt(unmaskMoney($(".rate-sl4").val()));
	...
	$("#cuerpo-completo1").on('click',function(){
		var valArr = [6, 7, 10, 12, 14, 15, 16, 18, 19, 20, 21, 24, 27, 28, 32, 33];
	...
	$(".listado-bancos").ready( function(){
	   ...
	   //Función para limpiar select2 si no esta check venta compartida
	   $("#compartida").click(function(){
        if($(this).prop("checked") == false){
            $('.listado-enfermeras').empty();
        }
        else{
            $('#loader').removeClass('hidden');
	...
	$(document).ready(function(){
		...
		$(document).on('click', '#btnsubmitTwo', function(){
			$('#tp1').prop("disabled", false);
			$('#tp2').prop("disabled", false);
			$('#parcialidades').prop("disabled", false);
	...
	$().ready(function(){
		$("#miform").validate({
			...
			messages: {
				...
				'lugar_prospeccion':{
                    required: "Seleccione el lugar de prospección"
                },
				'tipoCobro':{
					required: "Dato requerido"
				},
				...
				'cardNumber[]':{
					required: "Dato requerido",
                    minlength: jQuery.validator.format("Ingresa un número de tarjeta válido (min. 15 a 16 dígitos)")
				},
				'mes[]':{
					required: "Dato requerido",
					minlength: "Formato MM",
                    min: "Ingrese un mes válido",
                    max: "Ingrese un mes válido"
				},
				'anio[]':{
					required: "Dato requerido",
					minlength: "Formato AA",
                    max: "Ingrese un año válido"
				},
				'referencia':{
					required: "Dato requerido"
				},
				...
				'areaslipo':{
                    required: "Seleccionar al menos una opción"
                }
			},
			...
			submitHandler: function(form) {
				...
				var tarjeta = 0;
				$.ajax({
					url: url2 + "Clientes/guardar_clientes",
					data: data,
					cache: false,
					contentType: false,
					processData: false,
	...
	function deselectMulti(){
		jQuery('#formaPago').multiselect('deselect', ['1', '2', '6']);
		$('#lblProtegida').addClass('d-none');
		$('#box-cash').addClass('d-none');
		$('.protegida').prop('checked', false);
		$('.protegida').prop("disabled", false);
	...
	function cleanTarjeta(){
		if(parseInt($('.precioFinal').val()) == parseInt($('#pagoCon').val())){
			$('#tp1').prop('selectedIndex',0);
			$('#tp2').prop('selectedIndex',0);
			$('#tp1').prop('disabled', true);
			$('#tp2').prop('disabled', true);
...
// Función para hacer el ajuste de centavos para que la sumatoria de el total entero.
	function ajusteCentavos(parcialidades, importe, precioFinal, montoEnganche){
        var importe_n = 0;
        var precio_uno = (parseInt(parcialidades) * parseFloat(importe).toFixed(2));
		var diferencia = parseFloat(( parseFloat(precioFinal - (precio_uno + montoEnganche))).toFixed(2));
		if (diferencia < 0) importe_n = importe - (diferencia * -1);
		else importe_n = importe + diferencia;
		return importe_n;
    }
   ...
   $(this).find('span').text(function(_, value){return value=='-'?'+':'-'});
	...
	$('#flechaDesplegar_6').click(function() {
        $("i", this).toggleClass("fa-chevron-up fa-chevron-down");
    });
    $('#flechaDesplegar_7').click(function() {
        $("i", this).toggleClass("fa-chevron-up fa-chevron-down");
    });
    $('#flechaDesplegar_8').click(function() {
        $("i", this).toggleClass("fa-chevron-up fa-chevron-down");
    });
    $('#flechaDesplegar_9').click(function() {
        $("i", this).toggleClass("fa-chevron-up fa-chevron-down");
    });
    $('#flechaDesplegar_10').click(function() {
        $("i", this).toggleClass("fa-chevron-up fa-chevron-down");
    });
	...
	function validateEmptyFields() {
        let serviceType = $("#area_sel").val();

        let inputName = document.getElementsByName('nombre[]');
        let inputLastname = document.getElementsByName('apellido_paterno[]');

        let selectOne = $(".select-uno").val();
        let selectTwo = $(".select-dos").val();
        let selectThree = $(".select-tres").val();
        let selectFour = $(".select-cuatro").val();
        let selectFive = $(".select-cinco").val();

        let selectSix = $("#select6").val();
        let selectSeven = $("#select7").val();
        let selectEight = $("#select8").val();
        let selectNine = $("#select9").val();
        let selectTen = $("#select10").val();

        if (serviceType == 1 || serviceType == 2 || serviceType == 3) { // MJ: DEPLICACIÓN, MOLDEO Y DEPILACIÓN & MOLDEO
            if ((selectOne != '' && (inputName[0].value == '' || inputLastname[0].value == '')) || (selectTwo != '' && (inputName[1].value == '' || inputLastname[1].value == '')) ||
                (selectThree != '' && (inputName[2].value == '' || inputLastname[2].value == '')) || (selectFour != '' && (inputName[3].value == '' || inputLastname[3].value == '')) ||
                (selectFive != '' && (inputName[4].value == '' || inputLastname[4].value == ''))) { // MJ: SOME FIELD IS EMPTY
                jQuery("#modalRequiredFields").modal("show");
            } else { // MJ: REQUIRED FIELDS ARE FILL
                $('#btnsubmitTwo').click();
            }
        } else if (serviceType == 4) { // MJ: FACIAL
            if ((selectSix != '' && (inputName[0].value == '' || inputLastname[0].value == '')) || (selectSeven != '' && (inputName[1].value == '' || inputLastname[1].value == '')) ||
                (selectEight != '' && (inputName[2].value == '' || inputLastname[2].value == '')) || (selectNine != '' && (inputName[3].value == '' || inputLastname[3].value == '')) ||
                (selectTen != '' && (inputName[4].value == '' || inputLastname[4].value == ''))) { // MJ: SOME FIELD IS EMPTY
                jQuery("#modalRequiredFields").modal("show");
            } else { // MJ: REQUIRED FIELDS ARE FILL
                $('#btnsubmitTwo').click();
            }
        } else if (serviceType == 5) { // MJ: FACIAL Y MOLDEO
            if (((selectOne != '' || selectSix != '') && (inputName[0].value == '' || inputLastname[0].value == '')) || ((selectTwo != '' || selectSeven != '') && (inputName[1].value == '' || inputLastname[1].value == '')) ||
                ((selectThree != '' || selectEight != '') && (inputName[2].value == '' || inputLastname[2].value == '')) || ((selectFour != '' || selectNine != '') && (inputName[3].value == '' || inputLastname[3].value == '')) ||
                ((selectFive != '' || selectTen != '') && (inputName[4].value == '' || inputLastname[4].value == ''))) { // MJ: SOME FIELD IS EMPTY
                jQuery("#modalRequiredFields    ").modal("show");
            } else { // MJ: REQUIRED FIELDS ARE FILL
                $('#btnsubmitTwo').click();
            }
