...
class Archivos extends CI_Controller {
    ...
    function contratoDepilacion($area, $nombreTitular, $numeroTarjeta, $banco, $saldoPendiente, $mensualidad, $prosa, $fecha_inicial, $quincenaValue){
        $html = '';
        $html .= '<p align="center" style="page-break-before:always; font-size:12px;"><b>CONTRATO DE PRESTACIÓN DE SERVICIOS PROFESIONALES PARA EL TRATAMIENTO DE DEPILACIÓN LÁSER QUE CELEBRAN POR UNA PARTE “COSOMI & C.O.”. DE C.V.” CON NOMBRE COMERCIAL “BODY EFFECT”, REPRESENTADO EN ESTE ACTO POR FABIOLA GUERRERO ABREGO; A QUIEN EN LO SUCESIVO SE LE DENOMINARÁ “EL PRESTADOR” Y POR LA OTRA PARTE '.$nombreTitular.', A QUIEN EN LO SUCESIVO SE LE DENOMINARÁ “EL CLIENTE”; MISMOS QUE EN SU CONJUNTO SE IDENTIFICARÁN COMO “LAS PARTES” DE CONFORMIDAD CON LAS SIGUIENTES:</b><br></p>';
        $html .= '<p align="center" style="font-size:12px;">D E C L A R A C I O N E S</p><br><br><p align="justify" style="font-size:12px;"><b style="text-decoration: underline">I. DECLARA "EL PRESTADOR" QUE: </b><br><ol style="list-style-type: lower-alpha;"><li>Es una empresa legalmente constituida de conformidad en la República Mexicana, lo cual acredita mediante Escritura Pública número 15,837 de fecha 16 de octubre del 2019 otorgada ante la fe del notario público número <b>veintinueve</b>, Licenciado LEOPOLDO MONDRAGÓN GONZÁLEZ, misma que fue debidamente inscrita en el Registro Público de la Propiedad y del Comercio. Se hace constar la constitución de la Sociedad Civil Denominada “COSOMI & CO”.</li><li>Su objeto social le permite celebrar el acto que por el presente instrumento que se materializa.</li><li>Se encuentra inscrito bajo el Régimen General de Ley Personas Morales desde el 16 de octubre del año 2019, y que dentro de sus actividades económicas están los servicios profesionales, científicos y técnicos.</li><li>Su domicilio fiscal es el ubicado en CALLE 5 DE MAYO #75, COLONIA CENTRO, QUERÉTARO, QUERÉTARO.</li><li>Que su Registro Federal de Contribuyentes es el identificado como CAN191016KT8.</li><li>Declara que es su voluntad la celebración del presente contrato y que a la firma de este no existe ningún tipo de dolo, violencia o mala fe.</li></ol><br><br>II. <b style="text-decoration: underline"> Declara "EL CLIENTE" QUE:</b><ol style="list-style-type: lower-alpha;"><li>Es una persona física con capacidad jurídica propia, identificándose mediante ____________________________________, que lleva por nombre '. $nombreTitular .', mayor de edad.</li><li>Su domicilio habitual es el ubicado en _________________________________</li><li>Cuenta con capacidad económica suficiente para asumir la responsabilidad y compromiso de pago derivada de la firma del presente contrato</li><li>Declara bajo protesta que toda la información brindada para llevar a cabo el objeto del presente contrato es verídica y que es su voluntad la celebración del presente instrumento y que a la firma de éste no existe ningún tipo de dolo, violencia o mala fe.</li></ol><br><br>III. <b style="text-decoration: underline">DECLARAN "LAS PARTES" QUE:</b><ol style="list-style-type: lower-alpha;"><li></ol>La relación jurídica existente entre <b>“EL CLIENTE”</b> y <b>“EL PROVEEDOR”</b> es de carácter estrictamente comercial, por ende, la firma del presente contrato no crea asociación, sociedad o alguna otra figura jurídica, y cada una de las partes es responsable de sus obligaciones de carácter civil, laboral, fiscal y de cualquier otra naturaleza preexistentes o bien, derivadas tanto de su relación con las personas con quienes se auxilien para el cumplimiento del objeto del presente instrumento como para el cumplimiento de la normatividad que les aplique en razón de las actividades a las que se dedican;</li><li>B.	Se reconocen mutuamente la personalidad jurídica y la capacidad legal con la que se ostentan, por lo que declaran que no existen vicios en el consentimiento, tales como dolo, mala fe, violencia y lesión o cualquier otro vicio que en determinado momento pueda nulificar el presente contrato. Asimismo, manifiestan que conocen el alcance y contenido de este instrumento y están de acuerdo en someterse a las siguientes:</li></p><br><br><p align="center" style="font-size:12px;">C L Á U S U L A S:</p><br><p align="justify" style="font-size:12px;"><b>I. OBJETO.</b> El objeto del presente contrato es el tratamiento estético proporcionado por “EL PRESTADOR”, consistente en la depilación láser para la remoción y diminución del vello corporal en las áreas corporales previamente seleccionadas por “EL CLIENTE”, dicho servicio constará de un mínimo de 10 sesiones, mismas que deberán llevarse a cabo cada 45 días entre sesión por mes. “EL CLIENTE” se compromete a no exceder y a asistir a su cita de depilación estética en un plazo máximo de 60 días entre sesión y sesión desde la última realizada por “EL PRESTADOR”, de lo contrario se rescindirá el presente contrato sin derecho a reembolso alguno. Una vez firmado el presente contrato, las áreas corporales que se someterán a tratamiento estético, objeto del presente contrato no podrán cambiarse ni modificarse.</p>';

        $html .= $this->leyendaProsa($area, $prosa, $numeroTarjeta, $banco, $saldoPendiente, $mensualidad, $fecha_inicial, $quincenaValue);

        $html .= '<p align="justify" style="font-size:12px;">III. <b>GARANTÍA.</b> “EL PRESTADOR” se obliga y compromete a eliminar de un 90% a un 95% del vello únicamente en las áreas previamente seleccionadas por “EL CLIENTE”, mismas que se muestran en la carátula del presente contrato, por lo que las sesiones comprenden de un mínimo de 10 hasta lograr el objetivo mencionado.<br>En el caso de que posterior a la décima sesión de “EL CLIENTE”, éste no cuente con la eliminación del vello grueso en el porcentaje previamente mencionado y de haber cumplido en tiempo a la asistencia puntual y oportuna de sus sesiones, éste último tendrá derecho a obtener las sesiones posteriores totalmente gratis. En el supuesto de que “EL CLIENTE” para la veinteava sesión no haya obtenido la remoción del 90% a pesar de cumplir en tiempo a sus sesiones, el dinero le será devuelto en su totalidad<br>Al término del tratamiento, “LAS PARTES” deberán celebrar la firma del alta de “EL CLIENTE”, donde manifieste su conformidad con los resultados obtenidos. En caso de que dentro del plazo de 90 (noventa) días naturales posteriores a la fecha de firma de dicha alta, “EL CLIENTE” presentase aumento de vello en las áreas tratadas, podrá hacer uso de la garantía para obtener las sesiones correspondientes y de esta manera obtener el resultado mencionado.<br>La garantía no podrá ser exigible bajo los casos siguientes: i) En caso de no acudir de forma mensual a recibir su tratamiento. ii) En caso de interrumpir su tratamiento por más de 60 (sesenta) días naturales, iii) En caso de no acudir a la valoración a partir de la séptima sesión y bajo los términos indicados por el personal asignado, iv) En caso de que celebrada el alta, hayan transcurrido más de 90 días naturales.<br><b>IV. REEMBOLSO.</b> “EL CLIENTE” se hace sabedor y acepta en este acto que no existen reembolsos totales ni parciales sobre los paquetes contratados y apegándose a dicha política acepta los términos y condiciones del presente contrato. El único caso en el que se podrá otorgar un reembolso económico es que para la sesión número 20 (veinte) y a pesar del cumplimiento puntual de “EL CLIENTE” dentro del tiempo ya mencionado, habrá un reembolso del precio total pagado.<br><b>V. RETOQUES.</b> “EL PRESTADOR” se obliga a brindar dos retoques en las áreas contratadas por “EL CLIENTE” sin costo adicional. Dichos retoques serán aplicables en un plazo de 90 (noventa) días naturales y 180 (ciento ochenta) días naturales respectivamente posteriores a la firma de alta.<br>En el mismo sentido, “EL CLIENTE” se hace sabedor que dichos retoques no son acumulables, transferibles, ni prorrogables por ningún motivo, por lo que es su responsabilidad agendar las citas en los plazos previamente mencionados. En el caso de no asistir a los retoques correspondientes, no se otorgará reembolso, bonificación o garantía alguna.<br><br><b>VI. VALORACIONES.</b> A partir de la séptima sesión, “EL CLIENTE” se obliga a acudir a las instalaciones un día natural previo a su sesión agendada para una valoración libre de costo alguno. Dicha valoración se llevará a cabo con la finalidad de constatar el progreso y resultados de “EL CLIENTE” y en el supuesto de que este no se presente, la sesión correspondiente no podrá llevarse a cabo.<br><br><b>VII. SUSPENSIÓN DEL TRATAMIENTO. </b>“EL CLIENTE” puede suspender el tratamiento sin responsabilidad alguna en una única ocasión, en los supuestos de causa mayor ajena a “EL CLIENTE”, embarazo o salida del país, dando aviso mediante una carta sellada de recibido a “EL PRESTADOR” en la que explicará los motivos de la interrupción del tratamiento, pudiendo regresar después de máximo un año contado a partir del aviso de suspensión, para seguir recibiendo el tratamiento sin la pérdida de la garantía, siempre tomando en cuenta lo mencionado en la cláusula III.<br>Una vez transcurrido el año de suspensión del tratamiento, “EL CLIENTE” perderá el derecho a reanudar su tratamiento junto con el 100% de cualquier pago o abono efectuado, así como la garantía aplicable, por lo que en caso de que “EL CLIENTE” desee utilizar de nuevo los servicios de “EL PRESTADOR” se celebrará un nuevo contrato.<br><br><b>VIII. EFECTOS SECUNDARIOS DIVERSOS Y RESPONSABILIDAD. </b>“EL CLIENTE” se hace sabedor y está consciente de que el láser utilizado para el tratamiento objeto del mismo contrato está autorizado por la COFEPRIS mediante el folio COS/DED2/2/OR153301CO260100/2015 y que este mismo puede causar algunos efectos secundarios como lo son, enrojecimiento, dermatitis, manchas, o algún tipo de quemadura, asumiendo conjuntamente el riesgo con la empresa, sin embargo, en el caso de presentarse alguna lesión, la empresa se compromete a darle apoyo mediante su médico dermatólogo de cabecera mediante las citas y medicamentos necesarios para sanar dicha lesión.<br>En virtud de lo estipulado en el párrafo anterior, “EL PRESTADOR” no se hará responsable por cualquier efecto secundario que llegare a afectarle, derivado del tratamiento objeto del presente contrato, deslindándose de cualquier daño o perjuicio. Para ello “EL CLIENTE” reconoce haber otorgado su consentimiento informado y declara que la información proporcionada es verídica, por lo cual exime a “EL PRESTADOR” de cualquier complicación o afectación que se pudiera suscitar por haber otorgado información de forma imprecisa, falsa o que haya sido omitida y que derive en complicaciones para su salud.  <br>A efecto de evitar y, en su caso, castigar cualquier conducta indebida por parte del personal de “EL PRESTADOR” y/o de “EL CLIENTE”, desde este momento, éste último otorga su consentimiento para que dentro de las cabinas se cuente con equipo de grabación de audio para monitorear, NO CÁMARAS, únicamente audio y evitar conductas indebidas, quedando prohibidas de igual forma las propinas al personal.<b>IX. AVISO DE PRIVACIDAD. </b>“EL CLIENTE” manifiesta conocer y acepta los términos del AVISO DE PRIVACIDAD y el tratamiento que se le darán a los datos personales de los cuales es titular, incluyendo aquellos clasificados como datos sensibles, por lo que otorga u consentimiento total sobre la manera en que se recaban, y se hace sabedor de los derechos que tiene en su carácter de titular.<br><b>X. PROHIBICIÓN DE CESIÓN DE CONTRATO.</b> “LAS PARTES” no podrán ceder a terceras personas físicas o morales sus derechos y obligaciones derivados de este contrato y sus anexos, así como los derechos de cobro sobre los bienes y trabajos ejecutados que ampara este contrato, sin previa aprobación expresa y por escrito de la contraparte.<br><br><b>XI. JURISDICCIÓN Y COMPETENCIA. </b>Para la interpretación y cumplimiento del presente contrato, “LAS PARTES” se someten a las leyes y tribunales competentes en Santiago de Querétaro, Querétaro, renunciando a cualesquier otros que pudieren corresponderles por razón de su domicilio presente o futuro o por cualquier otra causa<br><br><b>Leído que fue el presente contrato y enteradas “LAS PARTES” de su contenido, alcance y fuerza legal lo firman en la ciudad de Querétaro, Querétaro, a '.strftime("%e del mes de  %B del %Y").'.<br><br><br><br><br><br><br><br></p>';
        return $html;
    }

    function contratoMoldeo($area, $nombreTitular, $numeroTarjeta, $banco, $saldoPendiente, $mensualidad, $prosa, $fecha_inicial, $quincenaValue){
        $html = '';
    ...
    function contratoDepMol($area, $nombreTitular, $numeroTarjeta, $banco, $saldoPendiente, $mensualidad, $prosa, $fecha_inicial, $quincenaValue){
        $html = '';
    ...
    function contratoFacial($area, $nombreTitular, $numeroTarjeta, $banco, $saldoPendiente, $mensualidad, $prosa, $fecha_inicial, $allAreas, $quincenaValue, $correoTitular, $domicilioTitular){
...
Leído en su totalidad el presente contrato y bien enteradas de su contenido y alcances legales <b>“LAS PARTES”</b>, lo firman por duplicado en la Ciudad de Santiago de Querétaro, Querétaro., el día ' . date("d") . ' de ' . strftime("%B") . ' del ' . date("Y") . '.<br><br><br><br>';
    ...
    function contratoFacMol($area, $nombreTitular, $numeroTarjeta, $banco, $saldoPendiente, $mensualidad, $prosa, $fecha_inicial, $allAreas, $quincenaValue, $correoTitular, $domicilioTitular){
        $html = '
            <table style="page-break-before:always;">
                <tr>
                    <td><img src="'.base_url("assets/img/logo.png").'" style="width:250px; height:75px;"></td>
...
<b>DÉCIMA PRIMERA.- COMPETENCIA.-</b> LAS PARTES manifiestan que para dirimir cualquier controversia respecto del objeto del presente contrato y las consecuencias inherentes al mismo, se designa a los tribunales competentes de Querétaro, Querétaro, renunciando a la jurisdicción que por domicilio les pudiese corresponder; en la inteligencia de que las quejas o reclamaciones relativas a la competencia de la Procuraduría Federal del Consumidor (PROFECO) atendiendo al ámbito federal que les compete, ambas partes están de acuerdo en dar cumplimiento a la mismas en razón de su respectivo domicilio. Leído en su totalidad el presente contrato y bien enteradas de su contenido y alcances legales <b>“LAS PARTES”</b>, lo firman por duplicado en la Ciudad de Santiago de Querétaro, Querétaro., el día' . date("d") . ' de ' . strftime("%B") . ' del ' . date("Y") . '.<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>';
    ...
    function leyendaProsa($area, $prosa, $numeroTarjeta, $banco, $saldoPendiente, $mensualidad, $fecha_inicial, $quincenaValue){
        $html = '';
        if ( $prosa == 1 ){
            if($area == 1){
                $html .= '<p align="justify" style="font-size:12px;"><b>II. PAGO.</b> “EL CLIENTE” autoriza que el pago se realice a su tarjeta de crédito de la institución bancaria '. $banco .' número de tarjeta '. $numeroTarjeta .' por la cantidad total de <b><u>$'.number_format($saldoPendiente, 2).'</u></b>, en pagos parciales consecutivos, cada uno por la cantidad de <b><u>'.$quincenaValue.'</u></b>, a partir del día <b><u>'.date("d-m-Y",strtotime($fecha_inicial)).'</u></b>. De igual forma, “EL CLIENTE” autoriza que los cobros se puedan realizar en un solo momento o en parcialidades en caso de que la cuenta tenga fondos insuficientes, pudiendo “EL PRESTADOR” y la empresa procesadora de pagos realizar el intento de cobro las veces que se estimen necesarias hasta lograr el cargo por la cantidad adeudada, independientemente de que “EL CLIENTE” asista a sus sesiones de tratamiento objeto del presente contrato.</p>';
            }
            else{
