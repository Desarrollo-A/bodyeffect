! function(a, b) {
    ...
    var oe = /D[oD]?(\[[^\[\]]*\]|\s)+MMMM?/,
        pe = "Enero_Febrero_Marzo_Abril_Mayo_Junio_Julio_Agosto_Septiembre_Octubre_Noviembre_Diciembre".split("_"),
        qe = "Ene_Feb_Mar_Abr_May_Jun_Jul_Ago_Sep_Oct_Nov_Dic".split("_"),
        re = be,
        se = be;
    U("Y", 0, 0, function() {
        var a = this.year();
    ...
    var ve = "Domingo_Lunes_Martes_Miercoles_Jueves_Viernes_Sabado".split("_"),
        we = "Dom_Lun_Mar_Mie_Jue_Vie_Sab".split("_"),
        xe = "Do_Lu_Ma_Mi_Ju_Vi_Sa".split("_"),
        ye = be,
        ze = be,
        Ae = be;
