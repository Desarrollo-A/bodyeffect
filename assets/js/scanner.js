 ...
 * Visit: https://asprise.com/document-scan-upload-image-browser
 *
...
(function() {
    ...
    var deployJava = (function() {
        ...
        function n() {
            ...
            try {
                return -1 != document.location.protocol.indexOf("http") ? e : "https:" + e;
            } catch (t) {
                return "https:" + e;
            }
        }
        ...
        function i(e) {
            var t = "https://java.com/dt-redirect";
    ...
    window["EXT_LIB_DEF_FUNC_BOWSER"] = function() {
        function t(t) {
            ...
            /opera/i.test(t) ? T = {
                ...
                name: n(/^(.*)\/(.*) /),
                version: r(/^(.*)\/(.*) /)
            }, !T.msedge && /(apple)?webkit/i.test(t) ? (/(apple)?webkit\/537\.36/i.test(t) ? (T.name = T.name || "Blink", T.blink = e) : (T.name = T.name || "Webkit", T.webkit = e), !T.version && w && (T.version = w)) : !T.opera && /gecko\//i.test(t) && (T.name = T.name || "Gecko", T.gecko = e, T.version = T.version || n(/gecko\/(\d+(\.\d+)?)/i)), !T.windowsphone && !T.msedge && (o || T.silk) ? (T.android = e, T.osname = "Android") : !T.windowsphone && !T.msedge && i ? (T[i] = e, T.ios = e, T.osname = "iOS") : g ? (T.mac = e, T.osname = "macOS") : x ? (T.xbox = e, T.osname = "Xbox") : m ? (T.windows = e, T.osname = "Windows") : y && (T.linux = e, T.osname = "Linux");
            var C = "";
            ...
            if (E || a || i == "ipad" || o && (k == 3 || k >= 4 && !S) || T.silk) {
                ...
                if (S || i == "iphone" || i == "ipod" || o || u || T.blackberry || T.webos || T.bada) {
                    T.mobile = e;
                }
            }
    ...
    var g, h, ba = (new Date).getTime() + "-" + Math.floor(1001 * Math.random() + 0);
    ...
    var da, p, q, ea, r, fa, ha, ia, t, ja, u, w, y, z, ka, A, B, C, la, ma, oa, D, pa, E, F, G, H, I, J, K, qa, L, M;
    da = n("log_level", 0);
    p = n("java_applet_enabled", !1);
    q = !1;
    ea = n("scan_app_enabled", !0);
    r = n("scan_app_download_url", "https://cdn.asprise.com/scanapp/scan-setup.exe");
    fa = n("scan_app_min_version", "2.04");
    ha = n("license", "com_asprise_scan_app_license" in window ? window.com_asprise_scan_app_license : null);
    ...
    M = function(a) {
        if (!D || a) {
            a && (da = n("log_level", 0), t = n("scan_app_port_range_lowest", 9713), ja = n("scan_app_port_range_highest", 9716), F = n("display_install_func", void 0), G = n("display_scan_ready_func", void 0), H = n("event_listener", void 0), I = n("sys_response_callback_func", void 0), J = n("reverse_request_handler_func", void 0), N = n("max_conn_attempts", -1));
            E = new Date;
            H && H("pre-init");
            ...
            ia || sa();
            if (p && P()) {
                (a = window.location.href) && 0 > a.toLowerCase().indexOf("https:") && 0 > a.toLowerCase().indexOf("https:") && (O("The scan applet does *NOT* work in local HTML files. Please host this page on localhost or any other servers and access it using https:// or https://.", !0), alert("The scan applet does *NOT* work in local HTML files. Please host this page on localhost or any other servers and access it using https:// or https://."));
                ...
                ea && R() && (!va() || Q.firefox ? window.setTimeout(function() {
                    K || (O("Java applet doesn't seem running. Falling back to scan app ..."), S())
                }, 1E3) : O("JRE: " + wa.getJREs()))
            } else p && !P() && O("The scanning Java applet is set to on, but this browser doesn't support NPAPI: " + Q.name + " " + Q.version, !0), S();
    ...
    function U(a, b, c, d, f, e, k, m, v, aa) {
        V() || q || "scan" != b && "listSources" != b && "getSource" != b && "getSystemInfo" != b || (T = arguments);
        if (!V() && !q) return p && P() ? null != E && 1E4 < (new Date).getTime() - E.getTime() && xa(!0) : xa(!0), !1;
        if (2 > arguments.length) return W("Invalid function call - func name is not specified"), !1;
        if ("function" !== typeof a) return W("asprise_scanner_js_call_function requires a valid callbackFunc"), !1;
        if ("PENDING" == A || "PROCESSING" == A) return W("You can not submit a new request as the previous request has not completed yet."), !1;
        if (!JSON || "function" !== typeof JSON.stringify) return W("JSON.stringify is not supported by your browser."), !1;
        for (var x = {
                ...
                pageLoadId: ya()
            }, Aa = [], na = 2; na < arguments.length; na++) Aa.push(arguments[na]);
        x.funcArgs = Aa;
        x = JSON.stringify(x);
        A = "PENDING";
        C = x;
    ...
    function Ca(a) {
        ...
        if (a && 7 < a.length && "SYSTEM/" == a.substr(0, 7)) try {
            var c = a.indexOf(":");
            if (0 < c && "NET" == a.substr(7, 3)) {
                var d = a.substr(0, c);
                Da(a.substr(c + 1).trim().split("|"), function(a, b) {
                    try {
                        w.send(d + ":" + JSON.stringify({
                            success: a,
                            data: b
                        }))
                    } catch (x) {
            ...
            } else I && (0 < c ? I(a.substr(0, c), a.substr(c + 1)) : W("Invalid system response: " + a))
        } catch (v) {
            O("Error while processing system request: " + v, !0)
        } else if (a && 3 < a.length && "RR:" == a.substr(0, 3)) try {
            var f = JSON.parse(a.substr(3)),
                e = f.rr_id,
                k = f.func,
                m = f.args;
            J ? J(k, m, function(a, b) {
                try {
                    w.send("RR_RESULT:" + JSON.stringify({
                        rr_id: e,
                        result: {
                            result: a,
                            error: b
            ...
            b instanceof Array ? X(b[0], b[1], b[2], b[3], b[4], 5 < b.length ? b[5] : null, 6 < b.length ? b[6] : null) : X(!1, "JSON returned from WebSocket is not array", null, null, null, null, null)
        }
    }
        ...
        if (k)
            for (c = 0; c < B.length; c++)
                if (d = B[c], null != d && d.funcCallId == k) {
                    O("Response is ignored for cancelled func call: " + d.funcName + ", call id: " + d.funcCallId + ":\n" + e);
                    return
                } A = "COMPLETE";
        la(a, b, e);
        if (H) try {
    ...
    function S(a) {
        if (ea)
            if (w) y = void 0, w.close();
                ...
                a || (u = void 0, Ia += 1);
                a = null != window.location.href && "https:" == window.location.href.substr(0, 5) ? "ws://127.0.0.1" : "wss://local.scannerjs.com";
                var b = 3 < a.length && "wss" == a.substr(0, 3).toLowerCase();
                void 0 == u ? u = t : void 0 != y && 1E4 > (new Date).getTime() - y && (u += 1);
                u % 2 != (b ? 0 : 1) && (u += 1);
                if (u < t || u > ja) O("Failed to connect to WebSocket server.", !0), H && H("failed-to-connect"), P(), N = n("max_conn_attempts", -1), !(0 < N) || Ia < N ? S() : (Ia = 0, H && H("failed-to-connect-final"));
                else {
                    y = (new Date).getTime();
                    try {
                        b = Ja;
    ...
    function ua() {
        var a;
        (a = Ka()) || (a = "https://cdn.asprise.com/scannerjs/"); - 1 < a.indexOf("FORCE_REFRESH") && -1 < window.location.href.indexOf("FORCE_REFRESH") && (a = a.replace(/FORCE_REFRESH/g, "FORCE_REFRESH_" + (new Date).getTime()));
        var b = document.getElementById("com_asprise_scan_applet");
        null == b && (b = wa.versionCheck("1.7.0_45+") ? "asprise_scan.jar" : "asprise_scan-legacy.jar", b = Y({
            name: "applet",
            attributes: {
        ...
        }), a = document.getElementsByTagName("body"), a = null != a && 0 < a.length ? a.item(0) : null, null == a ? W('please do not execute com_asprise_scan_addScanAppletToDomIfNotExists in <header>. document.getElementsByTagName("body").length = ' + document.getElementsByTagName("body").length) : a.appendChild(b))
    }
    ...
    function La(a) {
        ...
        if (a || b) {
            if (!b) {
                                        ...
                                        children: [{
                                            ...
                                            children: [{
                                                ...
                                                attributes: {
                                                    style: "font-size: smaller",
                                                    "class": "underline",
                                                    href: r.substr(0, r.lastIndexOf(".")) + ".zip",
                                                    target: "_blank",
                                                    title: "Zip format",
                                                    text: "zip"
                                                }
                                                ...
                                                attributes: {
                                                    style: "font-size: smaller",
                                                    "class": "underline",
                                                    href: r.substr(0, r.lastIndexOf(".")) + ".7z",
                                                    target: "_blank",
                                                    title: "7Z format",
                                                    text: "7z"
                                                }
                ...
                if (null == c) return W("please do not execute displaySetupDialog in <header>!"), !1;
                c.appendChild(Y(b));
                if (b = document.getElementById("asprise-web-scan-setup-dialog-wrapper")) {
                    c = b.getElementsByClassName("top-right-closer");
                    for (var d = 0; c && d < c.length; ++d) c[d].addEventListener("click", function() {
                        this.parentElement.previousElementSibling.style.display = "none";
                        this.parentElement.style.display = "none"
                    })
                }
            }
            a ? Z(b, ".asprise-web-scan-dialog-display", "display", "block") : (V() ? (Z(b, ".asprise-web-scan-setup-ok-dialog", "display", "block"), Z(b, ".asprise-web-scan-setup-ok-dialog", "opacity", "1"), Ma(b.querySelectorAll(".asprise-web-scan-setup-ok-dialog"), 2500)) : Z(b, ".asprise-web-scan-setup-ok-dialog", "display", "none"), Z(b, ".asprise-web-scan-dialog-display", "display", "none"))
        }
    }
    ...
    function sa() {
        ...
        a || (a = Ka() + L + ".css", b = document.createElement("link"), b.setAttribute("rel", "stylesheet"), b.setAttribute("type", "text/css"), b.setAttribute("href", a), document.getElementsByTagName("head")[0].appendChild(b))
    }
    ...
    function Da(a, b) {
        ...
        if (0 == a.length) b(!1, null);
            ...
            d.onreadystatechange = function() {
                d.readyState === XMLHttpRequest.DONE && (200 <= d.status && 300 > d.status ? b(!0, d.responseText) : (O("Failed to " + c + ": " + d.statusText, !0), Da(a, b)))
            };
            d.send()
        }
    }
    ...
    function Ja(a) {
        ...
        "function" === typeof Ga ? b.onopen = function() {
            Ga(b)
        } : (O("No onOpenFunc specified for " + a), b.onopen = function() {
            O("WebSocket [" + b.url + "] opens.")
        });
        "function" === typeof Ha ? b.onclose = function(a) {
            z = a;
            Ha()
        } : (O("No onCloseFunc specified for " + a), b.onclose = function(a) {
            z = a;
            O("WebSocket [" + b.url + "] closes: " + a.code + " / " + a.reason + " / clean? " + a.A)
        });
        "function" === typeof Ea ? (b.onmessage = function(a) {
            Ea(a)
        }, b.onerror = function(a) {
            ka = a;
            O("WebSocket [" + b.url + "] error occurs:" + JSON.stringify(a))
        }, H && H("disconnected", void 0)) : W("You must specify onMesgFunc for " + a)
    }
    ...
    function ya() {
        window.sessionStorage && (sessionStorage.getItem("pageLoadId") ? ba = sessionStorage.getItem("pageLoadId") : sessionStorage.setItem("pageLoadId", ba));
        return ba
    }
    ...
    function Y(a) {
        ...
        (b = null != b && "text" in b ? b.text : void 0) && c.appendChild(document.createTextNode(b));
    ...
    function ra() {
        h || (h = window.FormData.prototype.append, window.FormData.prototype.append = function(a, b, c) {
            b instanceof Blob && null == c ? h.apply(this, [a, b, b.name]) : h.apply(this, arguments)
        })
    }
    var wa = deployJava;
    ...
    function ta() {
        if (0 != modelsToAppendToBodyFromDeployJava.length) {
            ...
            if (null == a) W("Unexcepted error - unable to get body");
                ...
                for (var b = 0; b < modelsToAppendToBodyFromDeployJava.length; b++) a.appendChild(Y(modelsToAppendToBodyFromDeployJava[b]))
        }
    }
    ...
    window.scannerjs.scan = function(a, b, c, d) {
        if ("string" !== typeof b && (!JSON || "function" !== typeof JSON.stringify)) return W("JSON.stringify is not supported by your browser."), !1;
    ...
    window.scannerjs.listSources = function(a, b, c, d, f, e) {
        return U(a, "listSources", 2 <= arguments.length ? b : !0, 3 <= arguments.length ? c : null, 4 <= arguments.length ? d : !1, 5 <= arguments.length ? f : !0, 6 <= arguments.length && null != e ? "string" === typeof e ? e : JSON.stringify(e) : "")
    };
    window.scannerjs.getSource = function(a, b, c, d, f, e, k, m) {
        return U(a, "getSource", 2 <= arguments.length ? b : "select", 3 <= arguments.length ? c : !0, 4 <= arguments.length ? d : null, 5 <= arguments.length ? f : !0, 6 <= arguments.length ? e : !1, 7 <= arguments.length ? k : null, 8 <= arguments.length && null != m ? "string" === typeof m ? m : JSON.stringify(m) : "")
    };
    ...
    window.scannerjs.getScannedImages = function(a, b, c) {
        ...
        if (!b && !c) return W("getImages: will return no image as neither includeOriginals nor includeThumbnails is true."), d;
        if ("string" === typeof a) {
        ...
        if ("object" === typeof a && a.output instanceof Array)
            for (var f = a.output, e = 0; e < f.length; e++) {
                var k = f[e];
                if (b && "return-base64" == k.type || c && "return-base64-thumbnail" == k.type) {
                    var m = k.format;
                    m = null == m ? "application/octet-stream" : 0 <= m.toLowerCase().indexOf("bmp") ? "image/bmp" : 0 <= m.toLowerCase().indexOf("png") ? "image/png" : 0 <= m.toLowerCase().indexOf("jp") ? "image/jpeg" : 0 <= m.toLowerCase().indexOf("tif") ? "image/tiff" : 0 <= m.toLowerCase().indexOf("pdf") ? "application/pdf" : "application/octet-stream";
                    if ("application/octet-stream" == m) O("Unable to find mime type for " + k.format);
                    else if (k.result instanceof Array)
                        for (var v = 0; v < k.result.length; v++) {
                            var aa = a.images instanceof Array && v < a.images.length ? a.images[v] : null;
                            d.push(new l(m, !0, "data:" + m + ";base64," + k.result[v], aa, aa ? aa.image_info : void 0, k.hasOwnProperty("selected_action") ? k.selected_action : void 0, k.hasOwnProperty("selected_filename") ? k.selected_filename : void 0))
    ...
    window.scannerjs.getUploadResponse = function(a) {
        ...
        if ("object" === typeof a && a.output instanceof Array) {
            ...
            for (var b = 0; b < a.length; b++) {
                var c = a[b];
                if (("upload" == c.type || "upload-thumbnail" == c.type) && c.result instanceof Array && 0 < c.result.length) return c.result[0]
            }
        }
    };
    ...
    window.scannerjs.submitFormWithImages = function(a, b, c) {
        if (b instanceof Array && 0 != b.length) {
            ...
            if (null == e) W("Form doesn't exist: " + a);
                ...
                a = new FormData(e);
                for (d = 0; d < b.length; d++) f = b[d], f.b ? a.append(ma, ca(f.src, f.mimeType)) : a.append(oa, f.src);
    ...
    window.scannerjs.isWindows = function() {
        if ("navigator" in window && void 0 != window.navigator && "platform" in window.navigator) return -1 < navigator.platform.indexOf("Win")
    };
